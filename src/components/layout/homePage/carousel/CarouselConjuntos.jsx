...
import { useCarouselConjuntos } from '../../../functions/homePage/carousel/CarouselFunctions'
...
function CarouselConjuntos() {
    const { user } = useContext(UserContext);

    const [produtos, setProdutos] = useState([]);
    const [produtosConjuntos, setProdutosConjuntos] = useState([]);
    ...
    const { counterSlideConjuntos, prevSlideConjuntos, nextSlideConjuntos } = useCarouselConjuntos(produtosConjuntos.length)
        ...
        <ContainerCarousel>
            ...
            <Carousel>
                ...
                <CarouselHidden>
                    ...
                    <CarouselSlide style={{ transform: `translateX(${-counterSlideConjuntos * slideWidthGap}rem)` }}>
                        {/* Mapeamento dos produtos da categoria "conjuntos" */}
                        {produtosConjuntos.map((produto, index) => (
                ...
                <NextCarousel onClick={nextSlideConjuntos}>&#10095;</NextCarousel>
            </Carousel>
        </ContainerCarousel>
    )
}

export default CarouselConjuntos
