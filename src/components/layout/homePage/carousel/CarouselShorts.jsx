...
import { useCarouselShorts } from '../../../functions/homePage/carousel/CarouselFunctions'
...
function CarouselShorts() {
    ...
    const [produtosShorts, setProdutosShorts] = useState([]);
    ...
    const { counterSlideShorts, prevSlideShorts, nextSlideShorts } = useCarouselShorts(produtosShorts.length)

    {/* UseEffect responsável por passar as imagens do carrossel a cada 6 segundos automaticamente. */ }
    useEffect(() => {
        ...
        <ContainerCarousel>
            ...
            <Carousel>
                ...
                <CarouselHidden>
                    ...
                    <CarouselSlide style={{ transform: `translateX(${-counterSlideShorts * slideWidthGap}rem)` }}>
                        {/* Mapeamento dos produtos da categoria "shorts" */}
                        {produtosShorts.map((produto, index) => (
                ...
                <NextCarousel onClick={nextSlideShorts}>&#10095;</NextCarousel>
            </Carousel>
        </ContainerCarousel>
    )
}
