...
import { useCarouselMacaquinhos } from '../../../functions/homePage/carousel/CarouselFunctions'
...
function CarouselMacaquinhos() {
    const { user } = useContext(UserContext);

    const [produtos, setProdutos] = useState([]);
    const [produtosMacaquinhos, setProdutosMacaquinhos] = useState([]);
    ...
    const { counterSlideMacaquinhos, prevSlideMacaquinhos, nextSlideMacaquinhos } = useCarouselMacaquinhos(produtosMacaquinhos.length)

    // UseEffect responsável por passar as imagens do carrossel automaticamente
    useEffect(() => {
        const intervaloId = setInterval(() => {
            nextSlideMacaquinhos();
        }, 6000);
        ...
        <ContainerCarousel>
            ...
            <Carousel>
                ...
                <CarouselHidden>
                    ...
                    <CarouselSlide style={{ transform: `translateX(${-counterSlideMacaquinhos * slideWidthGap}rem)` }}>
                        {/* Mapeamento dos produtos da categoria "macaquinhos" */}
                        {produtosMacaquinhos.map((produto, index) => (
                ...
                <NextCarousel onClick={nextSlideMacaquinhos}>&#10095;</NextCarousel>
            </Carousel>
        </ContainerCarousel>
    )
}

export default CarouselMacaquinhos
