...
import { useCarouselVestidos } from '../../../functions/homePage/carousel/CarouselFunctions'
...
function CarouselVestidos() {
    const { user } = useContext(UserContext);

    const [produtos, setProdutos] = useState([]);
    const [produtosVestidos, setProdutosVestidos] = useState([]);
    ...
    const { counterSlideVestidos, prevSlideVestidos, nextSlideVestidos } = useCarouselVestidos(produtosVestidos.length);
    ...
    return (
        <ContainerCarousel>
            <TituloCarousel>Vestidos</TituloCarousel>
            <Carousel>
                <PrevCarousel onClick={prevSlideVestidos}>&#10094;</PrevCarousel>
                <CarouselHidden>
                    <CarouselSlide style={{ transform: `translateX(${-counterSlideVestidos * slideWidthGap}rem)` }}>
                        {/* Mapeamento dos produtos da categoria "vestidos" */}
                        {produtosVestidos.map((produto, index) => (
                ...
                <NextCarousel onClick={nextSlideVestidos}>&#10095;</NextCarousel>
            </Carousel>
        </ContainerCarousel>
    );
}

export default CarouselVestidos;
